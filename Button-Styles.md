All examples use Deep Purple as the Primary Color and Lime as the Secondary/Accent color. Floating Tool Action Buttons are using the ['Settings' material icon](https://materialdesignicons.com/icon/settings).
